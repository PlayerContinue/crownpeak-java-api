...
public final class MakeRequest {
	 ...
	 */
	public static final <T> T makeRequest(String urlPath, APIRequest request, APIData apiData, Class<T> responseClass)  {
	 ...
	 * @throws URISyntaxException 
	 */
	public static final <T> T makeRequestSync(String urlPath, APIRequest request, APIData apiData, Class<T> responseClass) {
		return MakeRequest.makeRequestSyncV2("https://"+ apiData.host + "/" + apiData.instance + 
				"/" + apiData.webAPIRoot + MakeRequest.modifyURLPath(urlPath), request,apiData, responseClass);
	}
	 ...
	 * @throws IOException
	 */
	public static final <T> T makeRequestSyncV2(String url, APIRequest request, APIData apiData, Class<T> responseClass) {
		...
		try {
			...
			return convertToResponseObject(response,responseClass);
	...
	public static final HttpResponse makeRequest(String url, APIRequest request, APIData apiData) throws ClientProtocolException, IOException {
	...
	public static <T> T convertToResponseObject(HttpResponse response, Class<T> responseClass) throws IllegalStateException, IOException {
